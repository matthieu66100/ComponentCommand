...
//#include <sstream>
	...
	{
		array<String^>^ rowData = lines[i]->Split(';');
		array<String^>^ dateNum = rowData[0]->Split('/'); // à convertir en int le 0 et le 1
...
*/
	...
	String^ num = year + "/" + numCom; //lire les données du champ et recuperer le chiffre le plus élevé.
